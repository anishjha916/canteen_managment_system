...
?>
    <!-- <div class="container">
        ...
        <div class="container">
            <h1 id="table-name" class="shadow rounded border-0 border-secondary text-center text-uppercase ">Category table</h1>

            <div id="add_btn" class="shadow rounded ml-5 mt-2 b d-flex justify-content-end">

                <button type="button" class="border-0 shadow m-1 btn btn-primary" data-toggle="modal" data-target="#myModal"> Add category </button>
            </div>

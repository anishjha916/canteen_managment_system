...
?>
    <!-- <div class="container">
        ...
        <div class="container">
            <h1 id="table-name" class="shadow rounded border-0 border-secondary text-center text-uppercase ">Price table</h1>

            <div id="add_btn" class="shadow rounded ml-5 mt-2 d-flex justify-content-end">

                <button type="button" class="border-0 shadow m-1 btn btn-primary" data-toggle="modal" data-target="#myModal"> Add Price </button>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title text-uppercase">Add Price</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Price:</label>
                            <input type="text" placeholder="Enter Price" class="form-control" id="tax_name" name="">
        ...
        <div class="modal fade" id="update_tax_modal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title text-uppercase">Update Price</h4>
                        <button type="button" class="close" data-dismiss="modal">×</button>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Price:</label>
                            <input type="text" placeholder="Enter Price" class="form-control" id="update_tax_name" name="">
